...
const categories = ["Development", "Web 3", "AI/ML", "DSA", "Cybersecurity", "Game Development", "AR/VR"]
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col items-end">
                    ...
                    <div className="relative z-10 flex justify-end lg:mr-[-12%]">
                        <img
                            src="/houses/Gryffindor/Frame 42.svg"
                            alt="SVG"
                ...
                <div className="relative bg-[#9D0208] rounded-2xl p-4 sm:p-6 md:p-8 flex flex-col h-full justify-between">

                    {/* SVG Decoration */}
                    <div className="flex justify-center">
                        <img
                            src="/houses/Gryffindor/GryffCat.svg"
