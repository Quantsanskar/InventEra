...
const AnimatedCoolText = () => {
    return (
        <div className="h-[300px] sm:h-[400px] md:h-[500px] lg:h-64 w-full flex items-center justify-center bg-gradient-to-b from-[#0a1128] via-[#1a365d] to-[#1e3a8a] overflow-hidden">
