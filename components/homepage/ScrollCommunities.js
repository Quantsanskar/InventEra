                ...
                <div id="move" style={styles.move}>
                    {Array.from({ length: 10 }).map((_, index) => (
                        <div key={index} className="marquee" style={styles.marquee}>
                            <h1 className="text-3xl font-bold" style={styles.heading}>Communities With Us</h1>
                            <img
...
export default dynamic(() => Promise.resolve(DynamicMarqueeCommunity), { ssr: false });
