...
export const Compare = ({
    ...
    return (
        <div
            ref={sliderRef}
            className={cn(
                "w-[400px] h-[400px] overflow-hidden transform-gpu", // Added transform-gpu
                className
            )}
            style={{
                position: "relative",
        ...
        >
            ...
            <div className="overflow-hidden w-full h-full relative z-20 pointer-events-none">
                <AnimatePresence mode="wait" initial={false}>
                    {firstImage ? (
                        <motion.div
                            className={cn(
                                "absolute inset-0 z-20 rounded-2xl flex-shrink-0 w-full h-full select-none overflow-hidden transform-gpu",
                                firstImageClassName
                            )}
                            style={{
            ...
            <AnimatePresence mode="wait" initial={false}>
                {secondImage ? (
                    <motion.img
                        className={cn(
                            "absolute top-0 left-0 z-[19] rounded-2xl w-full h-full select-none transform-gpu",
                            secondImageClassname
                        )}
                        style={{
