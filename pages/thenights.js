...
const EventPage = () => {
  ...
  const mediacards = data.map((card, index) => <MediaCard key={index} card={card} index={index} />);
  return (
        ...
        <MacWindow title="Welcome to The Nights">
          <div className="space-y-4">
            ...
            <p className="text-lg mt-6">
              YOU BRING THE SPARK, WE BRING THE FUEL (AND THE PIZZA 🍕). IT&apos;S ALL ABOUT
              COLLABORATION, CREATIVITY, AND A LITTLE BIT OF CHAOS.
            </p>
            ...
            <div className="mt-8 flex justify-center">
              ...
              >
                ...
                {/* Button text */}
                <span
                  className="relative font-medium text-neutral-200
      ...
      <div className="min-h-screen w-full bg-black dark:bg-black flex items-center justify-center p-8">
        <div className="flex flex-col items-center gap-8">
          ...
          <p className="text-neutral-400 text-center max-w-lg mt-16 text-sm md:text-base">
            Experience the power of community - where solo developers become part of something
            bigger. Join us to accelerate your growth and unlock your full potential.
          </p>
        </div>
      </div>
