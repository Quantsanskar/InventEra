...
const HufflepuffHero = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-screen overflow-hidden bg-[#372e29]">
      {/* Animated Background */}
      <motion.div variants={backgroundVariants} initial="hidden" animate="visible" className="absolute inset-0">
        <motion.div
          ...
          style={{
            backgroundImage: `url(${encodeURI("/houses/HufflePuff/Huff-bg.png")})`,
      ...
      <motion.div className="absolute inset-0 pointer-events-none">
        {[...Array(30)].map((_, i) => (
          ...
          >
            <Dot size={Math.random() * 45 + 3} color="#FFD700" fill="#FFD700" />
          </motion.div>
        ))}
      </motion.div>
      ...
      >
        ...
        <motion.div variants={titleVariants} initial="hidden" animate="visible" className="relative mb-8">
          <h1
            className="font-bold text-5xl md:text-8xl lg:text-8xl text-center"
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="text-xl md:text-2xl text-center max-w-2xl mx-auto px-4 text-[#FFD700]"
          style={{
            fontFamily: "Cinzel, serif",
            textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5), 0 0 20px rgba(255, 215, 0, 0.4)",
          }}
        >
